        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TypePayment = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TypeShipment = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("buyers_pkey", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "text", nullable: false, defaultValueSql: "''::text"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("merchandises_pkey", x => x.Id);
                    table.ForeignKey(
                        name: "merchandises_brandid_fkey",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "merchandises_categoryid_fkey",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "merchandises_sizeid_fkey",
                        column: x => x.SizeId,
                        principalTable: "Sizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "merchandises_teamid_fkey",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("merchorders_pkey", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "merchorders_paymentid_fkey",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "merchorders_shipmentid_fkey",
                        column: x => x.ShipmentId,
                        principalTable: "Shipments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "merchorders_statusid_fkey",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("Reviews_pkey", x => x.Id);
                    table.ForeignKey(
                        name: "reviews_buyerid_fkey",
                        column: x => x.BuyerId,
                        principalTable: "Buyers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "reviews_merchandiseid_fkey",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("orderitems_pkey", x => new { x.OrderId, x.MerchId });
                    table.ForeignKey(
                        name: "orderitems_merchid_fkey",
                        column: x => x.MerchId,
                        principalTable: "Merchandises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Merchandises_SizeId",
                table: "Merchandises",
                column: "SizeId");

            migrationBuilder.CreateIndex(
                name: "IX_Merchandises_TeamId",
                table: "Merchandises",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_MerchOrders_BuyerId",
                table: "MerchOrders",
                column: "BuyerId");

            migrationBuilder.CreateIndex(
                name: "IX_MerchOrders_PaymentId",
                table: "MerchOrders",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_MerchOrders_ShipmentId",
                table: "MerchOrders",
                column: "ShipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_MerchOrders_StatusId",
                table: "MerchOrders",
                column: "StatusId");
